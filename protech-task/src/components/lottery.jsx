...
const Lottery = () => {
  const [drawChances, setDrawChances] = useState(
    localStorage.getItem("drawChance") ? localStorage.getItem("drawChance") : 7
  );
  const [wordsLeft, setWords] = useState(
    localStorage.getItem("wordsLeft") ? localStorage.getItem("wordsLeft") : 10
  );
  ...
  //     const hasNonZeroQuantity = Object.values(chars).some(
  //       (char) => char.quantity !== 0
  //     );
  ...
  useEffect(() => {
    ...
    const countZeroQuantityChars = chars.filter(
      (char) => char.quantity === 0
    ).length;
    ...
    <div className="row justify-content-center">
      <div className="row mx-0 justify-content-between my-3">
        ...
        <div className="col-6 text-start">
          <button className="btn btn-primary" onClick={incrementDate}>
            另一天
          </button>
        </div>
      </div>
      ...
      <div
        className="col-lg-4 col-md-8 col-12 px-0"
        style={{ border: "1px solid grey", borderBottom: "0" }}
      >
        <div className="row mx-0">
          <img className="px-0" src={mooncake} alt="" />
        </div>
        <div
          className="row ps-2 mx-0 py-3"
          style={{ borderBottom: "1px solid #ededed" }}
        >
          <div
            className="col-11 text-start mb-2"
            ...
            {new Date(currentDate) < novemberFirst2024 && (
              <div className="col-6">
                <button
                  ...
                  onClick={drawBigPrize}
                  disabled={prize == false}
                >
                  抽大奖
                </button>
              </div>
          ...
          <div className="modal-content">
            <div className="row justify-content-center mx-0">
              ...
              >
                ...
                <div
                  className="parent d-flex justify-content-center align-items-center"
                  style={{ height: "80%" }}
                >
